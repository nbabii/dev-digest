...
| [onion-architecture](onion-architecture/SKILL.md) | Backend | Onion/Clean/Hexagonal architecture: dependency rule, ports vs adapters, DI via the Container, Zod boundary vs domain invariants |
| [next-best-practices](next-best-practices/SKILL.md) | Frontend | Next.js App Router, RSC boundaries, data fetching, optimization |
| [react-best-practices](react-best-practices/SKILL.md) | Frontend | React anti-patterns, state management, hooks rules |
| [frontend-architecture](frontend-architecture/SKILL.md) | Frontend | UI architecture: folder layout, feature boundaries, where constants/utils/business logic live, avoiding duplication |
